...
using MailSample.Common;
using MailSample.Data;
using MailSample.Entity;
using MailSample.Models;

namespace MailSample.Repository
{
    /// <summary>
    /// メール送信ログリポジトリ
    ...
    {
        private readonly MailSampleDbContext _context;

        public MailLogRepository(MailSampleDbContext context) : base(context)
        {
            _context = context;
        }
