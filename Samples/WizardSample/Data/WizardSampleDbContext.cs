...
namespace WizardSample.Data
{
    /// <summary>
    /// WizardSample 専用 DBContext
    /// DevNextDB を共有し、Identity テーブルは同じテーブル名を使用する
    /// </summary>
    public class WizardSampleDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        public WizardSampleDbContext(DbContextOptions<WizardSampleDbContext> options) : base(options) { }
        ...
        public DbSet<WizardEntity> WizardEntities { get; set; }
    }
}
